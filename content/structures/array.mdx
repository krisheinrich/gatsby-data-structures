...
- <GatsbyLink to='/adts/3-queue'>Queue</GatsbyLink>
- <GatsbyLink to='/adts/4-priority-queue'>Priority Queue</GatsbyLink> (see <GatsbyLink to='/structures/heap'>Heap</GatsbyLink> implementation)
